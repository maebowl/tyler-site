...
const defaultData = {
  projects: [
    { id: 1, title: "Project One", description: "A mysterious scene rendered in cycles" },
    { id: 2, title: "Project Two", description: "Low-poly environment design" },
    { id: 3, title: "Project Three", description: "Character modeling experiment" },
  ],
  songs: [
    { id: 1, title: "Song Title One", artist: "Artist Name" },
    { id: 2, title: "Song Title Two", artist: "Artist Name" },
    { id: 3, title: "Song Title Three", artist: "Artist Name" },
    { id: 4, title: "Song Title Four", artist: "Artist Name" },
    { id: 5, title: "Song Title Five", artist: "Artist Name" },
  ],
  posts: [
    {
      slug: 'hello-world',
...
<p>Stay tuned for more posts coming soon!</p>`,
  ...
  socials: [
    { id: 'discord', name: 'Discord', handle: '@tyler', url: '#' },
    { id: 'youtube', name: 'YouTube', handle: 'Tyler Richardson', url: '#' },
    { id: 'twitch', name: 'Twitch', handle: 'tyler_streams', url: '#' },
    { id: 'letterboxd', name: 'Letterboxd', handle: 'tyler', url: '#' },
  ],
}
